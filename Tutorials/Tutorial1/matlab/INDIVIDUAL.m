...
dif_k=1;
   ...
   % Bad aggregate state and unemployed idiosyncratic state 
     ...
     k2prime_bu=interpn(k,km,kprime(:,:,1,1),kprime,kmprime,'cubic'); %Warning: The 'cubic' method requires the grid to have a uniform spacing.Switching the method from 'cubic' to 'spline' because this condition is not met. 
   ...
   % Bad aggregate state and employed idiosyncratic state
     ...
     k2prime_be=interpn(k,km,kprime(:,:,1,2),kprime,kmprime,'cubic');%Warning: The 'cubic' method requires the grid to have a uniform spacing.
   ...
   % Good aggregate state and unemployed idiosyncratic state
     ...
     k2prime_gu=interpn(k,km,kprime(:,:,2,1),kprime,kmprime,'cubic');%Warning: The 'cubic' method requires the grid to have a uniform spacing.
   ...
   % Good aggregate state and employed idiosyncratic state
     ...
     k2prime_ge=interpn(k,km,kprime(:,:,2,2),kprime,kmprime,'cubic');%Warning: The 'cubic' method requires the grid to have a uniform spacing.
