...
for t=1:T
   ...
   kprimet4=interpn(k,km,a2,epsilon2,kprime,k, kmts(t),agshock(t),epsilon2,'cubic');% Warning: The 'cubic' method requires at least 3 points in each dimension. Reverting to the default 'linear' method because this condition is not met. 
   ...
   kcrossn=interpn(k,epsilon2,kprimet,kcross,idshock(t,:),'cubic'); % Warning: The 'cubic' method requires at least 3 points in each dimension. Reverting to the default 'linear' method because this condition is not met. 
