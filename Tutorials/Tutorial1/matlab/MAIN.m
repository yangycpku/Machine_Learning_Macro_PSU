...
% with minor adapation by Yucheng Yang
%
...
N=10;          % number of agents for the stochastic simulation
...
save(strcat('../data/KS_policy_N', num2str(N), '_v1'), 'kprime', 'k', 'km', 'agshock', 'idshock', 'kmts', 'kcross');